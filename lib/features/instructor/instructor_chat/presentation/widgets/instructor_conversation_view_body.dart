...
class InstructorConversationViewBody extends StatefulWidget {
  const InstructorConversationViewBody({super.key});

  @override
  State<InstructorConversationViewBody> createState() =>
      _InstructorConversationViewBodyState();
}

class _InstructorConversationViewBodyState
    extends State<InstructorConversationViewBody> {
