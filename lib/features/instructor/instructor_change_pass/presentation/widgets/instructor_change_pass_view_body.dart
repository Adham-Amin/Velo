...
class InstructorChangePassViewBody extends StatefulWidget {
  const InstructorChangePassViewBody({super.key});

  @override
  State<InstructorChangePassViewBody> createState() =>
      _ChangePassViewBodyState();
}

class _ChangePassViewBodyState extends State<InstructorChangePassViewBody> {
